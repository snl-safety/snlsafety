...
<div class="special">
	<div class="container">
		...
		<div class="specia-top">
			<ul class="grid_2">
		<li>
				<a href="details.html"><img src="<c:url value="/resources/images/8.jpg"/>" class="img-responsive" alt=""></a>
		...
		<li>
				<a href="details.html"><img src="<c:url value="/resources/images/9.jpg"/>" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
		...
		<li>
				<a href="details.html"><img src="<c:url value="/resources/images/10.jpg"/>" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
		...
		<li>
				<a href="details.html"><img src="<c:url value="/resources/images/11.jpg"/>" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
